<!--Footer-->
<footer id="footer" class="footer-3" style="border: 5px solid #ef2b43;">
            ...
            <div class="footer-top">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links" style="margin-left: 5rem;">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 order-1 order-md-0 order-lg-0 order-sm-1 copyright text-sm-center text-md-left text-lg-left">
                        <P style="color: black;">
                            ...
                            </script> All rights reserved | Developed by <a href="#" target="_blank">S/R Soft BD</a>
                        </P>
                    </div>
                    <!--End Footer Copyright-->
                    <!--Footer Payment Icon-->
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 order-0 order-md-1 order-lg-1 order-sm-0 payment-icons text-right">
