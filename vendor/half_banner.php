                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM half_banner order by id desc";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td style="display: inline-flex;">
                                                    <a href="edit_halfbanner.php?id=<?php echo $row['id']?>" class="btn btn-icon btn-primary">Edit</a>
                                                    <form action="delete_halfbanner.php?id=<?php echo $row['id'] ?>" method="post">
